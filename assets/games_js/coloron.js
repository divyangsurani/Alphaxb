class Game {
    ...
    generateTweet() {
        ...
        window.open("https://twitter.com/intent/tweet?url=https://jalish.com/games/coloron I scored " + this.score + " points on Coloron! Can you beat my score?&amp;via=greghvns&amp;hashtags=coloron", "TweetWindow", "width=600px,height=300px,top=" + top + ",left=" + left);
    }
